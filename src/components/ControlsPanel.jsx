...
function ControlsPanel({ settings, onSettingChange, onReset, selectedIconName }) {
  ...
  return (
    <aside className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
      ...
      <div className="space-y-4">
        ...
        {activeTab === 'Export' && <ExportButtons iconName={selectedIconName} iconSize={settings.iconSize} />}
      </div>
